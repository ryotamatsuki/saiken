...
| R7/R8 fund cash balance input | DEFERRED | R7末又はR8期首の基金別現金残高は、令和8年9月議会で決算関係が審議中のため現時点では追わず、公表後の更新項目として保留 |
...
- R7末又はR8期首の基金別現金残高は、令和8年9月議会の決算関係審議中で現時点では確定資料を前提にできないため、bottom-up ALMの総額確定には使用せず、公表後に更新する。
- この保留により、条例・R8予算・R6決算・個別基金公表資料までの基金別用途・保持制約調査自体のQA PASSは維持する。
